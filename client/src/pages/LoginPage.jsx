      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        {serverStatus === STATUS.WAKING && (
          <div className="mb-4 px-4 py-3 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
            ...
            <p className="text-ink-500 text-xs mt-2 text-center">Sign in button unlocks automatically</p>
          </div>
        )}
        ...
        {serverStatus === STATUS.READY && (
          <div className="mb-4 px-4 py-2.5 bg-green-500/10 border border-green-500/20 rounded-xl flex items-center gap-2">
            ...
            <p className="text-green-400 text-xs font-medium">Server is ready — you can sign in!</p>
          </div>
        )}
        ...
        <div className="card p-8">
          ...
          <p className="text-center text-ink-400 text-sm mt-6">
            No account?{' '}
            <Link to="/register" className="text-accent hover:text-accent-light transition-colors font-medium">Create one</Link>
          </p>
        </div>
        ...
        <p className="text-center text-ink-600 text-xs mt-4">Demo: test@example.com / password123</p>
      </div>
    </div>
  );
}
